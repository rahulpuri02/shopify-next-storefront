...
import { ArrowUp, Loader2Icon, SquareIcon } from "lucide-react";
...
export const PromptInputSubmit = ({
  ...
  let Icon = <ArrowUp className={cn("size-4", !disabled && "text-slate-800")} />;
  ...
  return (
    <Button
      className={cn("gap-1.5 rounded-full bg-slate-200 hover:bg-slate-200", className)}
      size={size}
      type="submit"
      variant={variant}
      disabled={disabled}
